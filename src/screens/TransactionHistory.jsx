      ...
      >
        <motion.div
          ...
          style={{
            ...
            position: "relative",
            borderTop: "4px solid rgb(76,149,76)", // ✅ brand accent
          }}
        >
          {/* Header */}
          <div style={{ textAlign: "center", marginBottom: "20px" }}>
            <h2 style={{ margin: "0", color: "rgb(76,149,76)" }}>Bank Receipt</h2>
          ...
          <div style={{ fontSize: "14px", color: "#333" }}>
            <div style={{ display: "flex", justifyContent: "space-between", margin: "8px 0" }}>
              ...
              <span style={{ color: data.status === "active" ? "rgb(76,149,76)" : "red", fontWeight: 600 }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", margin: "8px 0" }}>
              ...
              <span style={{ fontWeight: "bold", color: "rgb(76,149,76)" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", marginTop: "20px" }}>
            ...
            <button
              onClick={handlePrint}
              style={{
                background: "rgb(76,149,76)", // ✅ brand color
                color: "white",
                border: "none",
                padding: "8px 16px",
                borderRadius: "6px",
