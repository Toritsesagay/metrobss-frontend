// MetroBSS Service Worker
const CACHE_NAME = 'metrobss-v1.0.0';
const STATIC_CACHE_NAME = 'metrobss-static-v1.0.0';
const DYNAMIC_CACHE_NAME = 'metrobss-dynamic-v1.0.0';
...
self.addEventListener('push', (event) => {
  ...
  const options = {
    body: event.data ? event.data.text() : 'New MetroBSS notification',
  ...
  event.waitUntil(
    self.registration.showNotification('MetroBSS', options)
  );
});
...
console.log('[SW] MetroBSS Service Worker loaded');
